...
var member = document.head.querySelector('meta[name="member"]');
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		update: function update(e) {
			...
			axios.post(api + 'updateCard/' + auth.id, formData).then(function (r) {
				location.reload();
			}).catch(function (r) {
				Bus.$emit('loading-end');
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		cancel: function cancel() {
			...
			axios.post(api + 'cancel/' + auth.id, { apiToken: auth.api_token }).then(function (r) {
		...
		onSubmit: function onSubmit(e) {
			...
			axios.post(api + 'token', formData).then(function (_ref) {
				...
				axios.post('/join', formData).then(function (_ref2) {
					...
					axios.post(api + 'subscribe', formData).then(function (_ref3) {
						var data = _ref3.data;
						console.log(data);
						...
						_this2.endInError(window.lan.payFailed);
					});
				...
				if (!response) {
					_this2.endInError(window.lan.badApi);
					return;
				}
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		fetch: function fetch() {
			...
			axios.get(api + 'invoices/' + auth.id + '?apiToken=' + auth.api_token).then(function (r) {
